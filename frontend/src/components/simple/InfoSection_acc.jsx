const InfoSection = () => {
    return (
      <section className="info-section">
        ...
        <h3>How It Works</h3>
        <p>On this page, you can recommend gyms and provide ratings based on your experience. Pinpoint your location or a gym you'd like to rate, fill out the dropdown menus with your preferences, and submit your recommendation!</p>
      </div>
