...
CREATE TABLE public.recommendation (
	...
	request_id uuid NOT NULL,
	currency_id uuid NOT NULL,
	CONSTRAINT recommendation_congestion_score_check CHECK (((congestion_score >= (0)::numeric) AND (congestion_score <= (10)::numeric))),
	CONSTRAINT recommendation_gym_id_request_id_key UNIQUE (gym_id, request_id),
	CONSTRAINT recommendation_pkey PRIMARY KEY (id),
	CONSTRAINT recommendation_rating_score_check CHECK (((rating_score >= (0)::numeric) AND (rating_score <= (10)::numeric))),
	CONSTRAINT recommendation_tcost_check CHECK ((tcost >= (0)::numeric)),
